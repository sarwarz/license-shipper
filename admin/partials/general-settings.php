    ...
    <form method="post" enctype="multipart/form-data" action="<?php echo admin_url('admin-post.php'); ?>">
        ...
        <table class="form-table">
			...
			<tr class="ls-section-header">
				<th colspan="2">
					<h3 style="margin: 20px 0 5px;">
						<?php _e('Single Sign-On (SSO) Settings', 'license-shipper'); ?>
					</h3>
					<p class="description" style="margin: 0;">
						<?php _e(
							'Configure secure Single Sign-On access between WordPress and your LicenseShipper application.',
							'license-shipper'
						); ?>
					</p>
				</th>
			...
			<tr>
				...
				<td class="forminp">
					<input
						...
						<?php echo get_option('lship_sso_enabled') === 'yes' ? '' : 'readonly'; ?>
					>
